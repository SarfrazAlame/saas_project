export const subscriptionsTiers = {
  Free: {
    name: "Free",
    priceInCents: 0,
...
export const subscriptionsTiersInOrder = [
  subscriptionsTiers.Free,
  subscriptionsTiers.Basic,
  subscriptionsTiers.Standard,
  subscriptionsTiers.Premium,
] as const;
